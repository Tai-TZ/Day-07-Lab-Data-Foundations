...
- [x] `EmbeddingStore.search` — embed query, rank by cosine similarity
...
- [x] Phase 2 benchmark: `py phase2_benchmark.py --embedder local --export report/phase2_results.json`
